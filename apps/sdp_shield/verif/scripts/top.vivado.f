...
${SHEF_LIB_DIR}/free_dma_ddr_slv.sv
${SHEF_LIB_DIR}/primitives/shield_counter.sv
${SHEF_LIB_DIR}/primitives/shield_muxes.sv
${SHEF_LIB_DIR}/primitives/axi_muxes.sv
${SHEF_LIB_DIR}/primitives/shield_rams.sv
${SHEF_LIB_DIR}/primitives/shield_regfiles.sv
${SHEF_LIB_DIR}/primitives/shield_regs.sv
${SHEF_LIB_DIR}/crypto/aes.sv
${SHEF_LIB_DIR}/crypto/aes_parallel.sv
${SHEF_LIB_DIR}/crypto/aes_core.v
${SHEF_LIB_DIR}/crypto/aes_encipher_block.v
${SHEF_LIB_DIR}/crypto/aes_key_mem.v
${SHEF_LIB_DIR}/crypto/aes_sbox.v
${SHEF_LIB_DIR}/crypto/hmac.sv
${SHEF_LIB_DIR}/crypto/hmac_stream.sv
${SHEF_LIB_DIR}/crypto/pmac.sv
${SHEF_LIB_DIR}/crypto/pmac_ntz.sv
${SHEF_LIB_DIR}/crypto/sha256_core.v
${SHEF_LIB_DIR}/crypto/sha256_k_constants.v
${SHEF_LIB_DIR}/crypto/sha256_w_mem.v
${SHEF_LIB_DIR}/stream/stream_cmd_gen.sv
${SHEF_LIB_DIR}/stream/stream.sv
${SHEF_LIB_DIR}/stream/stream_read.sv
${SHEF_LIB_DIR}/stream/stream_write.sv
${SHEF_LIB_DIR}/shield/shield_cmd_gen.sv
${SHEF_LIB_DIR}/shield/shield_controller.sv
${SHEF_LIB_DIR}/shield/shield_datapath.sv
${SHEF_LIB_DIR}/shield/shield_read_mstr.sv
${SHEF_LIB_DIR}/shield/shield_read_slv.sv
${SHEF_LIB_DIR}/shield/shield_write_mstr.sv
${SHEF_LIB_DIR}/shield/shield_write_slv.sv
${SHEF_LIB_DIR}/shield/shield_read_decryptor.sv
${SHEF_LIB_DIR}/shield/shield_write_encryptor.sv
${SHEF_LIB_DIR}/shield/shield_wrapper.sv
