...
#Create the project
create_project ${_xil_proj_name_} ../hw/${_xil_proj_name_} -part xczu3eg-sbva484-1-e

# Set the direc path for the new project
...
set files [list \
 [file normalize "${origin_dir}/hw/src/sources_1/bd/design_1/design_1.bd" ]\
 [file normalize "${origin_dir}/hw/src/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]\
]
